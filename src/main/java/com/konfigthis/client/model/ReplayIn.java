...
public class ReplayIn {
  ...
  **/
   ...
   * @return the ReplayIn instance itself
   */
  public ReplayIn putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.since, replayIn.since) &&
        ...
        Objects.equals(this.additionalProperties, replayIn.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ReplayIn>() {
           ...
           public ReplayIn read(JsonReader in) throws IOException {
             ...
             ReplayIn instance = thisAdapter.fromJsonTree(jsonObj);
