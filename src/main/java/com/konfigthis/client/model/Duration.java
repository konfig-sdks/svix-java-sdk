...
public class Duration {
  ...
  public Duration secs(Integer secs) {
    if (secs != null && secs < 0) {
      throw new IllegalArgumentException("Invalid value for secs. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public Duration nanos(Integer nanos) {
    if (nanos != null && nanos < 0) {
      throw new IllegalArgumentException("Invalid value for nanos. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.secs, duration.secs) &&
        Objects.equals(this.nanos, duration.nanos)&&
        Objects.equals(this.additionalProperties, duration.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(secs, nanos, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("secs");
    openapiRequiredFields.add("nanos");
  }
