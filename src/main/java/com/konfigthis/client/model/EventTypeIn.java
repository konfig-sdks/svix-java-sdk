...
public class EventTypeIn {
  ...
  **/
   ...
   * @return the EventTypeIn instance itself
   */
  public EventTypeIn putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, eventTypeIn.description) &&
        ...
        Objects.equals(this.additionalProperties, eventTypeIn.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, name, archived, schemas, featureFlag, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EventTypeIn>() {
           ...
           public EventTypeIn read(JsonReader in) throws IOException {
             ...
             EventTypeIn instance = thisAdapter.fromJsonTree(jsonObj);
