...
public class EndpointPatch {
  ...
  **/
   ...
   * @return the EndpointPatch instance itself
   */
  public EndpointPatch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, endpointPatch.description) &&
        ...
        Objects.equals(this.channels, endpointPatch.channels) &&
        Objects.equals(this.secret, endpointPatch.secret) &&
        Objects.equals(this.metadata, endpointPatch.metadata)&&
        Objects.equals(this.additionalProperties, endpointPatch.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EndpointPatch
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EndpointPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EndpointPatch is not found in the empty JSON string", EndpointPatch.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EndpointPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EndpointPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EndpointPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EndpointPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<EndpointPatch>() {
           @Override
           public void write(JsonWriter out, EndpointPatch value) throws IOException {
           ...
           @Override
           public EndpointPatch read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EndpointPatch instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  * @throws IOException if the JSON string is invalid with respect to EndpointPatch
  */
  public static EndpointPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EndpointPatch.class);
  }
