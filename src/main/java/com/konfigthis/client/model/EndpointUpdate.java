...
public class EndpointUpdate {
  ...
  **/
   ...
   * @return the EndpointUpdate instance itself
   */
  public EndpointUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, endpointUpdate.description) &&
        ...
        Objects.equals(this.additionalProperties, endpointUpdate.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, version, rateLimit, uid, url, disabled, filterTypes, channels, metadata, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EndpointUpdate>() {
           ...
           public EndpointUpdate read(JsonReader in) throws IOException {
             ...
             EndpointUpdate instance = thisAdapter.fromJsonTree(jsonObj);
