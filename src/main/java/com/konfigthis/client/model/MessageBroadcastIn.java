...
public class MessageBroadcastIn {
  ...
  public MessageBroadcastIn eventId(String eventId) {
    ...
    if (eventId != null && eventId.length() < 1) {
      throw new IllegalArgumentException("Invalid value for eventId. Length must be greater than or equal to 1.");
    }
  ...
  **/
  ...
  public MessageBroadcastIn payloadRetentionPeriod(Long payloadRetentionPeriod) {
    if (payloadRetentionPeriod != null && payloadRetentionPeriod < 5) {
      throw new IllegalArgumentException("Invalid value for payloadRetentionPeriod. Must be greater than or equal to 5.");
    }
    if (payloadRetentionPeriod != null && payloadRetentionPeriod > 90) {
      throw new IllegalArgumentException("Invalid value for payloadRetentionPeriod. Must be less than or equal to 90.");
    }
  ...
  **/
   ...
   * @return the MessageBroadcastIn instance itself
   */
  public MessageBroadcastIn putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventId, messageBroadcastIn.eventId) &&
        Objects.equals(this.eventType, messageBroadcastIn.eventType) &&
        Objects.equals(this.payload, messageBroadcastIn.payload) &&
        Objects.equals(this.channels, messageBroadcastIn.channels) &&
        Objects.equals(this.payloadRetentionPeriod, messageBroadcastIn.payloadRetentionPeriod)&&
        Objects.equals(this.additionalProperties, messageBroadcastIn.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventId, eventType, payload, channels, payloadRetentionPeriod, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MessageBroadcastIn
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MessageBroadcastIn.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MessageBroadcastIn is not found in the empty JSON string", MessageBroadcastIn.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MessageBroadcastIn.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("eventId").isJsonNull() && (jsonObj.get("eventId") != null && !jsonObj.get("eventId").isJsonNull()) && !jsonObj.get("eventId").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessageBroadcastIn.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessageBroadcastIn' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessageBroadcastIn> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessageBroadcastIn.class));

       return (TypeAdapter<T>) new TypeAdapter<MessageBroadcastIn>() {
           @Override
           public void write(JsonWriter out, MessageBroadcastIn value) throws IOException {
           ...
           @Override
           public MessageBroadcastIn read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MessageBroadcastIn instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MessageBroadcastIn given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MessageBroadcastIn
  * @throws IOException if the JSON string is invalid with respect to MessageBroadcastIn
  */
  public static MessageBroadcastIn fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessageBroadcastIn.class);
  }

 /**
  * Convert an instance of MessageBroadcastIn to an JSON string
  *
  * @return JSON string
  */
