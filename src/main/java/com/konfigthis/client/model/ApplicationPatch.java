...
public class ApplicationPatch {
  ...
  **/
   ...
   * @return the ApplicationPatch instance itself
   */
  public ApplicationPatch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, applicationPatch.name) &&
        Objects.equals(this.rateLimit, applicationPatch.rateLimit) &&
        Objects.equals(this.uid, applicationPatch.uid) &&
        Objects.equals(this.metadata, applicationPatch.metadata)&&
        Objects.equals(this.additionalProperties, applicationPatch.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, rateLimit, uid, metadata, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApplicationPatch
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApplicationPatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ApplicationPatch is not found in the empty JSON string", ApplicationPatch.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplicationPatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplicationPatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplicationPatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplicationPatch.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplicationPatch>() {
           @Override
           public void write(JsonWriter out, ApplicationPatch value) throws IOException {
           ...
           @Override
           public ApplicationPatch read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ApplicationPatch instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  * @throws IOException if the JSON string is invalid with respect to ApplicationPatch
  */
  public static ApplicationPatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplicationPatch.class);
  }
