...
public class TemplateIn {
  ...
  public TemplateIn description(String description) {
  ...
  **/
  ...
  public TemplateIn name(String name) {
  ...
  **/
  ...
  public TemplateIn logo(URI logo) {
  ...
  **/
  ...
  public TemplateIn kind(TransformationTemplateKind kind) {
  ...
  **/
  ...
  public TemplateIn instructions(String instructions) {
  ...
  **/
  ...
  public TemplateIn instructionsLink(URI instructionsLink) {
  ...
  **/
  ...
  public TemplateIn filterTypes(Set<String> filterTypes) {
  ...
  public TemplateIn addFilterTypesItem(String filterTypesItem) {
  ...
  **/
  ...
  public TemplateIn transformation(String transformation) {
    
    
    if (transformation != null && transformation.length() < 10) {
      throw new IllegalArgumentException("Invalid value for transformation. Length must be greater than or equal to 10.");
    }
  ...
  **/
  ...
  public TemplateIn featureFlag(String featureFlag) {
  ...
  **/
   ...
   * @return the TemplateIn instance itself
   */
  public TemplateIn putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TemplateIn templateIn = (TemplateIn) o;
    return Objects.equals(this.description, templateIn.description) &&
        Objects.equals(this.name, templateIn.name) &&
        Objects.equals(this.logo, templateIn.logo) &&
        Objects.equals(this.kind, templateIn.kind) &&
        Objects.equals(this.instructions, templateIn.instructions) &&
        Objects.equals(this.instructionsLink, templateIn.instructionsLink) &&
        Objects.equals(this.filterTypes, templateIn.filterTypes) &&
        Objects.equals(this.transformation, templateIn.transformation) &&
        Objects.equals(this.featureFlag, templateIn.featureFlag)&&
        Objects.equals(this.additionalProperties, templateIn.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, name, logo, kind, instructions, instructionsLink, filterTypes, transformation, featureFlag, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TemplateIn
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TemplateIn.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateIn is not found in the empty JSON string", TemplateIn.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TemplateIn.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateIn.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateIn' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateIn> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateIn.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateIn>() {
           @Override
           public void write(JsonWriter out, TemplateIn value) throws IOException {
           ...
           @Override
           public TemplateIn read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TemplateIn instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TemplateIn given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TemplateIn
  * @throws IOException if the JSON string is invalid with respect to TemplateIn
  */
  public static TemplateIn fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateIn.class);
  }

 /**
  * Convert an instance of TemplateIn to an JSON string
  *
  * @return JSON string
  */
