 ...
 */
@ApiModel(description = "A model containing information on a given message plus additional fields on the last attempt for that message.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class EndpointMessageOut {
  ...
  **/
   ...
   * @return the EndpointMessageOut instance itself
   */
  public EndpointMessageOut putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, endpointMessageOut.tags) &&
        ...
        Objects.equals(this.additionalProperties, endpointMessageOut.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, status, nextAttempt, eventId, eventType, payload, channels, id, timestamp, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EndpointMessageOut>() {
           ...
           public EndpointMessageOut read(JsonReader in) throws IOException {
             ...
             EndpointMessageOut instance = thisAdapter.fromJsonTree(jsonObj);
