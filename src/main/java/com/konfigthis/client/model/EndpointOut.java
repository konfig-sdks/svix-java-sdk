...
public class EndpointOut {
  ...
  **/
   ...
   * @return the EndpointOut instance itself
   */
  public EndpointOut putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, endpointOut.description) &&
        ...
        Objects.equals(this.additionalProperties, endpointOut.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, version, id, metadata, rateLimit, uid, url, disabled, filterTypes, channels, createdAt, updatedAt, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EndpointOut>() {
           ...
           public EndpointOut read(JsonReader in) throws IOException {
             ...
             EndpointOut instance = thisAdapter.fromJsonTree(jsonObj);
