...
public class MessageIn {
  ...
  **/
   ...
   * @return the MessageIn instance itself
   */
  public MessageIn putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, messageIn.tags) &&
        ...
        Objects.equals(this.application, messageIn.application) &&
        Objects.equals(this.transformationsParams, messageIn.transformationsParams)&&
        Objects.equals(this.additionalProperties, messageIn.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, eventId, eventType, payload, channels, payloadRetentionPeriod, application, transformationsParams, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("transformationsParams");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("application") != null && !jsonObj.get("application").isJsonNull()) {
        ApplicationIn.validateJsonObject(jsonObj.getAsJsonObject("application"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MessageIn>() {
           ...
           public MessageIn read(JsonReader in) throws IOException {
             ...
             MessageIn instance = thisAdapter.fromJsonTree(jsonObj);
