 ...
 */
@ApiModel(description = "The value of the headers is returned in the `headers` field.  Sensitive headers that have been redacted are returned in the sensitive field.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class EndpointHeadersOut {
  ...
  **/
   ...
   * @return the EndpointHeadersOut instance itself
   */
  public EndpointHeadersOut putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.headers, endpointHeadersOut.headers) &&
        ...
        Objects.equals(this.additionalProperties, endpointHeadersOut.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(headers, sensitive, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EndpointHeadersOut>() {
           ...
           public EndpointHeadersOut read(JsonReader in) throws IOException {
             ...
             EndpointHeadersOut instance = thisAdapter.fromJsonTree(jsonObj);
