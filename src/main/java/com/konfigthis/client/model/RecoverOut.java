...
public class RecoverOut {
  ...
  **/
   ...
   * @return the RecoverOut instance itself
   */
  public RecoverOut putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, recoverOut.id) &&
        ...
        Objects.equals(this.additionalProperties, recoverOut.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecoverOut
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecoverOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RecoverOut>() {
           ...
           public RecoverOut read(JsonReader in) throws IOException {
             ...
             RecoverOut instance = thisAdapter.fromJsonTree(jsonObj);
