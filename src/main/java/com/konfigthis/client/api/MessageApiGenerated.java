...
public class MessageApiGenerated {
    ...
    private okhttp3.Call createNewCall(String appId, MessageIn messageIn, Boolean withContent, String idempotencyKey, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createNewValidateBeforeCall(String appId, MessageIn messageIn, Boolean withContent, String idempotencyKey, final ApiCallback _callback) throws ApiException {
        ...
        if (messageIn == null) {
            throw new ApiException("Missing the required parameter 'messageIn' when calling createNew(Async)");
        }

        return createNewCall(appId, messageIn, withContent, idempotencyKey, _callback);

    }


    private ApiResponse<MessageOut> createNewWithHttpInfo(String appId, MessageIn messageIn, Boolean withContent, String idempotencyKey) throws ApiException {
        okhttp3.Call localVarCall = createNewValidateBeforeCall(appId, messageIn, withContent, idempotencyKey, null);
        Type localVarReturnType = new TypeToken<MessageOut>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewAsync(String appId, MessageIn messageIn, Boolean withContent, String idempotencyKey, final ApiCallback<MessageOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewValidateBeforeCall(appId, messageIn, withContent, idempotencyKey, _callback);
        Type localVarReturnType = new TypeToken<MessageOut>(){}.getType();
    ...
    public class CreateNewRequestBuilder {
        ...
        private CreateNewRequestBuilder(String eventType, Object payload, String appId) {
         ...
         */
        public CreateNewRequestBuilder tags(Set<String> tags) {
            this.tags = tags;
            return this;
        }
         ...
         * @return CreateNewRequestBuilder
         */
        public CreateNewRequestBuilder eventId(String eventId) {
         ...
         * @return CreateNewRequestBuilder
         */
        public CreateNewRequestBuilder payloadRetentionPeriod(Long payloadRetentionPeriod) {
         ...
         * @return CreateNewRequestBuilder
         */
        public CreateNewRequestBuilder application(ApplicationIn application) {
         ...
         * @return CreateNewRequestBuilder
         */
        public CreateNewRequestBuilder transformationsParams(Object transformationsParams) {
         ...
         * @return CreateNewRequestBuilder
         */
        public CreateNewRequestBuilder withContent(Boolean withContent) {
        ...
        public MessageOut execute() throws ApiException {
            MessageIn messageIn = buildBodyParams();
            ApiResponse<MessageOut> localVarResp = createNewWithHttpInfo(appId, messageIn, withContent, idempotencyKey);
        ...
        public ApiResponse<MessageOut> executeWithHttpInfo() throws ApiException {
            MessageIn messageIn = buildBodyParams();
            return createNewWithHttpInfo(appId, messageIn, withContent, idempotencyKey);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<MessageOut> _callback) throws ApiException {
            MessageIn messageIn = buildBodyParams();
            return createNewAsync(appId, messageIn, withContent, idempotencyKey, _callback);
        }
    }
     ...
     */
    public CreateNewRequestBuilder createNew(String eventType, Object payload, String appId) throws IllegalArgumentException {
        ...
        return new CreateNewRequestBuilder(eventType, payload, appId);
    }
