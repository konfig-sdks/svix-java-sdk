...
public class IntegrationApiGenerated {
    ...
    private okhttp3.Call listIntegrationsCall(String appId, Integer limit, String iterator, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listIntegrationsValidateBeforeCall(String appId, Integer limit, String iterator, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling listIntegrations(Async)");
        }

        return listIntegrationsCall(appId, limit, iterator, _callback);

    }


    private ApiResponse<ListResponseIntegrationOut> listIntegrationsWithHttpInfo(String appId, Integer limit, String iterator) throws ApiException {
        okhttp3.Call localVarCall = listIntegrationsValidateBeforeCall(appId, limit, iterator, null);
        Type localVarReturnType = new TypeToken<ListResponseIntegrationOut>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listIntegrationsAsync(String appId, Integer limit, String iterator, final ApiCallback<ListResponseIntegrationOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = listIntegrationsValidateBeforeCall(appId, limit, iterator, _callback);
        Type localVarReturnType = new TypeToken<ListResponseIntegrationOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListIntegrationsRequestBuilder {
        ...
        private ListIntegrationsRequestBuilder(String appId) {
            this.appId = appId;
        }
         ...
         * @return ListIntegrationsRequestBuilder
         */
        public ListIntegrationsRequestBuilder limit(Integer limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return ListIntegrationsRequestBuilder
         */
        public ListIntegrationsRequestBuilder iterator(String iterator) {
        ...
        public ListResponseIntegrationOut execute() throws ApiException {
            ApiResponse<ListResponseIntegrationOut> localVarResp = listIntegrationsWithHttpInfo(appId, limit, iterator);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<ListResponseIntegrationOut> executeWithHttpInfo() throws ApiException {
            return listIntegrationsWithHttpInfo(appId, limit, iterator);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ListResponseIntegrationOut> _callback) throws ApiException {
            return listIntegrationsAsync(appId, limit, iterator, _callback);
        }
    }
     ...
     */
    public ListIntegrationsRequestBuilder listIntegrations(String appId) throws IllegalArgumentException {
        if (appId == null) throw new IllegalArgumentException("\"appId\" is required but got null");
            if (appId != null && appId.length() < 1) {
              throw new IllegalArgumentException("Invalid value for appId. Length must be greater than or equal to 1.");
            }

        return new ListIntegrationsRequestBuilder(appId);
    }
    private okhttp3.Call rotateIntegrationKeyCall(String appId, String integId, String idempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call rotateIntegrationKeyValidateBeforeCall(String appId, String integId, String idempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling rotateIntegrationKey(Async)");
        }

        // verify the required parameter 'integId' is set
        if (integId == null) {
            throw new ApiException("Missing the required parameter 'integId' when calling rotateIntegrationKey(Async)");
        }

        return rotateIntegrationKeyCall(appId, integId, idempotencyKey, _callback);

    }


    private ApiResponse<IntegrationKeyOut> rotateIntegrationKeyWithHttpInfo(String appId, String integId, String idempotencyKey) throws ApiException {
        okhttp3.Call localVarCall = rotateIntegrationKeyValidateBeforeCall(appId, integId, idempotencyKey, null);
        Type localVarReturnType = new TypeToken<IntegrationKeyOut>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call rotateIntegrationKeyAsync(String appId, String integId, String idempotencyKey, final ApiCallback<IntegrationKeyOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = rotateIntegrationKeyValidateBeforeCall(appId, integId, idempotencyKey, _callback);
        Type localVarReturnType = new TypeToken<IntegrationKeyOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class RotateIntegrationKeyRequestBuilder {
        private final String appId;
        private final String integId;
        private String idempotencyKey;

        private RotateIntegrationKeyRequestBuilder(String appId, String integId) {
            this.appId = appId;
            this.integId = integId;
        }
         ...
         * Set idempotencyKey
         * @param idempotencyKey The request&#39;s idempotency key (optional)
         * @return RotateIntegrationKeyRequestBuilder
         */
        public RotateIntegrationKeyRequestBuilder idempotencyKey(String idempotencyKey) {
            this.idempotencyKey = idempotencyKey;
            return this;
        }
        
        /**
         * Build call for rotateIntegrationKey
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute rotateIntegrationKey request
         * @return IntegrationKeyOut
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public IntegrationKeyOut execute() throws ApiException {
            ApiResponse<IntegrationKeyOut> localVarResp = rotateIntegrationKeyWithHttpInfo(appId, integId, idempotencyKey);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute rotateIntegrationKey request with HTTP info returned
         * @return ApiResponse&lt;IntegrationKeyOut&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<IntegrationKeyOut> executeWithHttpInfo() throws ApiException {
            return rotateIntegrationKeyWithHttpInfo(appId, integId, idempotencyKey);
        }

        /**
         * Execute rotateIntegrationKey request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<IntegrationKeyOut> _callback) throws ApiException {
            return rotateIntegrationKeyAsync(appId, integId, idempotencyKey, _callback);
        }
    }
     ...
     */
    public RotateIntegrationKeyRequestBuilder rotateIntegrationKey(String appId, String integId) throws IllegalArgumentException {
        if (appId == null) throw new IllegalArgumentException("\"appId\" is required but got null");
            if (appId != null && appId.length() < 1) {
              throw new IllegalArgumentException("Invalid value for appId. Length must be greater than or equal to 1.");
            }
        ...
        return new RotateIntegrationKeyRequestBuilder(appId, integId);
    }
    private okhttp3.Call updateIntegrationCall(String appId, String integId, IntegrationUpdate integrationUpdate, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateIntegrationValidateBeforeCall(String appId, String integId, IntegrationUpdate integrationUpdate, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'appId' is set
        if (appId == null) {
        ...
        // verify the required parameter 'integId' is set
        if (integId == null) {
            throw new ApiException("Missing the required parameter 'integId' when calling updateIntegration(Async)");
        }

        // verify the required parameter 'integrationUpdate' is set
        if (integrationUpdate == null) {
            throw new ApiException("Missing the required parameter 'integrationUpdate' when calling updateIntegration(Async)");
        }

        return updateIntegrationCall(appId, integId, integrationUpdate, _callback);

    }


    private ApiResponse<IntegrationOut> updateIntegrationWithHttpInfo(String appId, String integId, IntegrationUpdate integrationUpdate) throws ApiException {
        okhttp3.Call localVarCall = updateIntegrationValidateBeforeCall(appId, integId, integrationUpdate, null);
        Type localVarReturnType = new TypeToken<IntegrationOut>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateIntegrationAsync(String appId, String integId, IntegrationUpdate integrationUpdate, final ApiCallback<IntegrationOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateIntegrationValidateBeforeCall(appId, integId, integrationUpdate, _callback);
        Type localVarReturnType = new TypeToken<IntegrationOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class UpdateIntegrationRequestBuilder {
        ...
        private UpdateIntegrationRequestBuilder(String name, String appId, String integId) {
            this.name = name;
            this.appId = appId;
            this.integId = integId;
        }
        ...
        /**
         * Execute updateIntegration request
         * @return IntegrationOut
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public IntegrationOut execute() throws ApiException {
            IntegrationUpdate integrationUpdate = buildBodyParams();
            ApiResponse<IntegrationOut> localVarResp = updateIntegrationWithHttpInfo(appId, integId, integrationUpdate);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateIntegration request with HTTP info returned
         * @return ApiResponse&lt;IntegrationOut&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<IntegrationOut> executeWithHttpInfo() throws ApiException {
            IntegrationUpdate integrationUpdate = buildBodyParams();
            return updateIntegrationWithHttpInfo(appId, integId, integrationUpdate);
        }

        /**
         * Execute updateIntegration request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<IntegrationOut> _callback) throws ApiException {
            IntegrationUpdate integrationUpdate = buildBodyParams();
            return updateIntegrationAsync(appId, integId, integrationUpdate, _callback);
        }
    }
     ...
     * @return UpdateIntegrationRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td>  </td><td>  -  </td></tr>
     ...
     */
    public UpdateIntegrationRequestBuilder updateIntegration(String name, String appId, String integId) throws IllegalArgumentException {
        if (name == null) throw new IllegalArgumentException("\"name\" is required but got null");
        ...
        return new UpdateIntegrationRequestBuilder(name, appId, integId);
    }
}
