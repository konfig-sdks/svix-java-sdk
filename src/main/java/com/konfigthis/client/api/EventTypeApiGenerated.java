...
public class EventTypeApiGenerated {
    ...
    private okhttp3.Call archiveCall(String eventTypeName, Boolean expunge, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call archiveValidateBeforeCall(String eventTypeName, Boolean expunge, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'eventTypeName' is set
        if (eventTypeName == null) {
            throw new ApiException("Missing the required parameter 'eventTypeName' when calling archive(Async)");
        }

        return archiveCall(eventTypeName, expunge, _callback);

    }


    private ApiResponse<Void> archiveWithHttpInfo(String eventTypeName, Boolean expunge) throws ApiException {
        okhttp3.Call localVarCall = archiveValidateBeforeCall(eventTypeName, expunge, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call archiveAsync(String eventTypeName, Boolean expunge, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = archiveValidateBeforeCall(eventTypeName, expunge, _callback);
    ...
    public class ArchiveRequestBuilder {
        ...
        private ArchiveRequestBuilder(String eventTypeName) {
         ...
         */
        public ArchiveRequestBuilder expunge(Boolean expunge) {
        ...
        public void execute() throws ApiException {
            archiveWithHttpInfo(eventTypeName, expunge);
        }
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return archiveWithHttpInfo(eventTypeName, expunge);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return archiveAsync(eventTypeName, expunge, _callback);
        }
    }
     ...
     */
    public ArchiveRequestBuilder archive(String eventTypeName) throws IllegalArgumentException {
        if (eventTypeName == null) throw new IllegalArgumentException("\"eventTypeName\" is required but got null");
            

        return new ArchiveRequestBuilder(eventTypeName);
    }
    ...
    private okhttp3.Call getEventTypeCall(String eventTypeName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getEventTypeValidateBeforeCall(String eventTypeName, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'eventTypeName' is set
        if (eventTypeName == null) {
            throw new ApiException("Missing the required parameter 'eventTypeName' when calling getEventType(Async)");
        }

        return getEventTypeCall(eventTypeName, _callback);

    }


    private ApiResponse<EventTypeOut> getEventTypeWithHttpInfo(String eventTypeName) throws ApiException {
        okhttp3.Call localVarCall = getEventTypeValidateBeforeCall(eventTypeName, null);
        Type localVarReturnType = new TypeToken<EventTypeOut>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getEventTypeAsync(String eventTypeName, final ApiCallback<EventTypeOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = getEventTypeValidateBeforeCall(eventTypeName, _callback);
        Type localVarReturnType = new TypeToken<EventTypeOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetEventTypeRequestBuilder {
        private final String eventTypeName;

        private GetEventTypeRequestBuilder(String eventTypeName) {
            this.eventTypeName = eventTypeName;
        }
         ...
         */
        public EventTypeOut execute() throws ApiException {
            ApiResponse<EventTypeOut> localVarResp = getEventTypeWithHttpInfo(eventTypeName);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<EventTypeOut> executeWithHttpInfo() throws ApiException {
            return getEventTypeWithHttpInfo(eventTypeName);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<EventTypeOut> _callback) throws ApiException {
            return getEventTypeAsync(eventTypeName, _callback);
        }
    }
     ...
     * Get an event type.
     * @param eventTypeName The event type&#39;s name (required)
     * @return GetEventTypeRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td>  </td><td>  -  </td></tr>
     ...
     */
    public GetEventTypeRequestBuilder getEventType(String eventTypeName) throws IllegalArgumentException {
        if (eventTypeName == null) throw new IllegalArgumentException("\"eventTypeName\" is required but got null");
            

        return new GetEventTypeRequestBuilder(eventTypeName);
    }
    ...
    private okhttp3.Call listCall(Integer limit, String iterator, Ordering order, Boolean includeArchived, Boolean withContent, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(Integer limit, String iterator, Ordering order, Boolean includeArchived, Boolean withContent, final ApiCallback _callback) throws ApiException {
        return listCall(limit, iterator, order, includeArchived, withContent, _callback);

    }


    private ApiResponse<ListResponseEventTypeOut> listWithHttpInfo(Integer limit, String iterator, Ordering order, Boolean includeArchived, Boolean withContent) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(limit, iterator, order, includeArchived, withContent, null);
        Type localVarReturnType = new TypeToken<ListResponseEventTypeOut>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer limit, String iterator, Ordering order, Boolean includeArchived, Boolean withContent, final ApiCallback<ListResponseEventTypeOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(limit, iterator, order, includeArchived, withContent, _callback);
        Type localVarReturnType = new TypeToken<ListResponseEventTypeOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
         ...
         * @return ListRequestBuilder
         */
        public ListRequestBuilder order(Ordering order) {
            this.order = order;
            return this;
        }
         ...
         * @return ListRequestBuilder
         */
        public ListRequestBuilder includeArchived(Boolean includeArchived) {
         ...
         * @return ListRequestBuilder
         */
        public ListRequestBuilder withContent(Boolean withContent) {
        ...
        public ListResponseEventTypeOut execute() throws ApiException {
            ApiResponse<ListResponseEventTypeOut> localVarResp = listWithHttpInfo(limit, iterator, order, includeArchived, withContent);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<ListResponseEventTypeOut> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(limit, iterator, order, includeArchived, withContent);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ListResponseEventTypeOut> _callback) throws ApiException {
            return listAsync(limit, iterator, order, includeArchived, withContent, _callback);
        }
    }
    ...
    private okhttp3.Call partiallyUpdateEventTypeCall(String eventTypeName, EventTypePatch eventTypePatch, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call partiallyUpdateEventTypeValidateBeforeCall(String eventTypeName, EventTypePatch eventTypePatch, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'eventTypeName' is set
        if (eventTypeName == null) {
            throw new ApiException("Missing the required parameter 'eventTypeName' when calling partiallyUpdateEventType(Async)");
        }

        // verify the required parameter 'eventTypePatch' is set
        if (eventTypePatch == null) {
            throw new ApiException("Missing the required parameter 'eventTypePatch' when calling partiallyUpdateEventType(Async)");
        }

        return partiallyUpdateEventTypeCall(eventTypeName, eventTypePatch, _callback);

    }


    private ApiResponse<EventTypeOut> partiallyUpdateEventTypeWithHttpInfo(String eventTypeName, EventTypePatch eventTypePatch) throws ApiException {
        okhttp3.Call localVarCall = partiallyUpdateEventTypeValidateBeforeCall(eventTypeName, eventTypePatch, null);
        Type localVarReturnType = new TypeToken<EventTypeOut>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call partiallyUpdateEventTypeAsync(String eventTypeName, EventTypePatch eventTypePatch, final ApiCallback<EventTypeOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = partiallyUpdateEventTypeValidateBeforeCall(eventTypeName, eventTypePatch, _callback);
        Type localVarReturnType = new TypeToken<EventTypeOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class PartiallyUpdateEventTypeRequestBuilder {
        private final String eventTypeName;
        ...
        private PartiallyUpdateEventTypeRequestBuilder(String eventTypeName) {
            this.eventTypeName = eventTypeName;
        }
         ...
         * @return PartiallyUpdateEventTypeRequestBuilder
         */
        public PartiallyUpdateEventTypeRequestBuilder description(String description) {
            this.description = description;
            return this;
        }
         ...
         * @return PartiallyUpdateEventTypeRequestBuilder
         */
        public PartiallyUpdateEventTypeRequestBuilder archived(Boolean archived) {
            this.archived = archived;
            return this;
        }
         ...
         * @return PartiallyUpdateEventTypeRequestBuilder
         */
        public PartiallyUpdateEventTypeRequestBuilder schemas(Map<String, Object> schemas) {
            this.schemas = schemas;
            return this;
        }
         ...
         * @return PartiallyUpdateEventTypeRequestBuilder
         */
        public PartiallyUpdateEventTypeRequestBuilder featureFlag(String featureFlag) {
            this.featureFlag = featureFlag;
            return this;
        }
        
        /**
         * Build call for partiallyUpdateEventType
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute partiallyUpdateEventType request
         * @return EventTypeOut
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public EventTypeOut execute() throws ApiException {
            EventTypePatch eventTypePatch = buildBodyParams();
            ApiResponse<EventTypeOut> localVarResp = partiallyUpdateEventTypeWithHttpInfo(eventTypeName, eventTypePatch);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute partiallyUpdateEventType request with HTTP info returned
         * @return ApiResponse&lt;EventTypeOut&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<EventTypeOut> executeWithHttpInfo() throws ApiException {
            EventTypePatch eventTypePatch = buildBodyParams();
            return partiallyUpdateEventTypeWithHttpInfo(eventTypeName, eventTypePatch);
        }

        /**
         * Execute partiallyUpdateEventType request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<EventTypeOut> _callback) throws ApiException {
            EventTypePatch eventTypePatch = buildBodyParams();
            return partiallyUpdateEventTypeAsync(eventTypeName, eventTypePatch, _callback);
        }
    }
     ...
     */
    public PartiallyUpdateEventTypeRequestBuilder partiallyUpdateEventType(String eventTypeName) throws IllegalArgumentException {
        if (eventTypeName == null) throw new IllegalArgumentException("\"eventTypeName\" is required but got null");
            

        return new PartiallyUpdateEventTypeRequestBuilder(eventTypeName);
    }
    private okhttp3.Call updateEventTypeNameCall(String eventTypeName, EventTypeUpdate eventTypeUpdate, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateEventTypeNameValidateBeforeCall(String eventTypeName, EventTypeUpdate eventTypeUpdate, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'eventTypeName' is set
        if (eventTypeName == null) {
            throw new ApiException("Missing the required parameter 'eventTypeName' when calling updateEventTypeName(Async)");
        }

        // verify the required parameter 'eventTypeUpdate' is set
        if (eventTypeUpdate == null) {
            throw new ApiException("Missing the required parameter 'eventTypeUpdate' when calling updateEventTypeName(Async)");
        }

        return updateEventTypeNameCall(eventTypeName, eventTypeUpdate, _callback);

    }


    private ApiResponse<EventTypeOut> updateEventTypeNameWithHttpInfo(String eventTypeName, EventTypeUpdate eventTypeUpdate) throws ApiException {
        okhttp3.Call localVarCall = updateEventTypeNameValidateBeforeCall(eventTypeName, eventTypeUpdate, null);
        Type localVarReturnType = new TypeToken<EventTypeOut>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateEventTypeNameAsync(String eventTypeName, EventTypeUpdate eventTypeUpdate, final ApiCallback<EventTypeOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateEventTypeNameValidateBeforeCall(eventTypeName, eventTypeUpdate, _callback);
        Type localVarReturnType = new TypeToken<EventTypeOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateEventTypeNameRequestBuilder {
        private final String description;
        private final String eventTypeName;
        private Boolean archived;
        private Map<String, Object> schemas;
        ...
        private UpdateEventTypeNameRequestBuilder(String description, String eventTypeName) {
            this.description = description;
            this.eventTypeName = eventTypeName;
        }
         ...
         * Set archived
         * @param archived  (optional, default to false)
         * @return UpdateEventTypeNameRequestBuilder
         */
        public UpdateEventTypeNameRequestBuilder archived(Boolean archived) {
            this.archived = archived;
            return this;
        }
         ...
         * @return UpdateEventTypeNameRequestBuilder
         */
        public UpdateEventTypeNameRequestBuilder schemas(Map<String, Object> schemas) {
            this.schemas = schemas;
            return this;
        }
         ...
         * @return UpdateEventTypeNameRequestBuilder
         */
        public UpdateEventTypeNameRequestBuilder featureFlag(String featureFlag) {
            this.featureFlag = featureFlag;
            return this;
        }
        
        /**
         * Build call for updateEventTypeName
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute updateEventTypeName request
         * @return EventTypeOut
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public EventTypeOut execute() throws ApiException {
            EventTypeUpdate eventTypeUpdate = buildBodyParams();
            ApiResponse<EventTypeOut> localVarResp = updateEventTypeNameWithHttpInfo(eventTypeName, eventTypeUpdate);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateEventTypeName request with HTTP info returned
         * @return ApiResponse&lt;EventTypeOut&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<EventTypeOut> executeWithHttpInfo() throws ApiException {
            EventTypeUpdate eventTypeUpdate = buildBodyParams();
            return updateEventTypeNameWithHttpInfo(eventTypeName, eventTypeUpdate);
        }

        /**
         * Execute updateEventTypeName request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<EventTypeOut> _callback) throws ApiException {
            EventTypeUpdate eventTypeUpdate = buildBodyParams();
            return updateEventTypeNameAsync(eventTypeName, eventTypeUpdate, _callback);
        }
    }
     ...
     */
    public UpdateEventTypeNameRequestBuilder updateEventTypeName(String description, String eventTypeName) throws IllegalArgumentException {
        if (description == null) throw new IllegalArgumentException("\"description\" is required but got null");
        ...
        return new UpdateEventTypeNameRequestBuilder(description, eventTypeName);
    }
}
