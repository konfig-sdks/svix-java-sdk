...
public class ApplicationApiGenerated {
    ...
    private okhttp3.Call updateApplicationByIdCall(String appId, ApplicationIn applicationIn, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateApplicationByIdValidateBeforeCall(String appId, ApplicationIn applicationIn, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling updateApplicationById(Async)");
        }

        // verify the required parameter 'applicationIn' is set
        if (applicationIn == null) {
            throw new ApiException("Missing the required parameter 'applicationIn' when calling updateApplicationById(Async)");
        }

        return updateApplicationByIdCall(appId, applicationIn, _callback);

    }


    private ApiResponse<ApplicationOut> updateApplicationByIdWithHttpInfo(String appId, ApplicationIn applicationIn) throws ApiException {
        okhttp3.Call localVarCall = updateApplicationByIdValidateBeforeCall(appId, applicationIn, null);
        Type localVarReturnType = new TypeToken<ApplicationOut>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateApplicationByIdAsync(String appId, ApplicationIn applicationIn, final ApiCallback<ApplicationOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateApplicationByIdValidateBeforeCall(appId, applicationIn, _callback);
        Type localVarReturnType = new TypeToken<ApplicationOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateApplicationByIdRequestBuilder {
        private final String name;
        private final String appId;
        private Integer rateLimit;
        private String uid;
        ...
        private UpdateApplicationByIdRequestBuilder(String name, String appId) {
            this.name = name;
            this.appId = appId;
        }
         ...
         * Set rateLimit
         * @param rateLimit  (optional)
         * @return UpdateApplicationByIdRequestBuilder
         */
        public UpdateApplicationByIdRequestBuilder rateLimit(Integer rateLimit) {
            this.rateLimit = rateLimit;
            return this;
        }
         ...
         * @return UpdateApplicationByIdRequestBuilder
         */
        public UpdateApplicationByIdRequestBuilder uid(String uid) {
            this.uid = uid;
            return this;
        }
         ...
         * @return UpdateApplicationByIdRequestBuilder
         */
        public UpdateApplicationByIdRequestBuilder metadata(Map<String, String> metadata) {
            this.metadata = metadata;
            return this;
        }
        
        /**
         * Build call for updateApplicationById
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute updateApplicationById request
         * @return ApplicationOut
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApplicationOut execute() throws ApiException {
            ApplicationIn applicationIn = buildBodyParams();
            ApiResponse<ApplicationOut> localVarResp = updateApplicationByIdWithHttpInfo(appId, applicationIn);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateApplicationById request with HTTP info returned
         * @return ApiResponse&lt;ApplicationOut&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<ApplicationOut> executeWithHttpInfo() throws ApiException {
            ApplicationIn applicationIn = buildBodyParams();
            return updateApplicationByIdWithHttpInfo(appId, applicationIn);
        }

        /**
         * Execute updateApplicationById request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ApplicationOut> _callback) throws ApiException {
            ApplicationIn applicationIn = buildBodyParams();
            return updateApplicationByIdAsync(appId, applicationIn, _callback);
        }
    }
     ...
     */
    public UpdateApplicationByIdRequestBuilder updateApplicationById(String name, String appId) throws IllegalArgumentException {
        if (name == null) throw new IllegalArgumentException("\"name\" is required but got null");
            if (name != null && name.length() < 1) {
              throw new IllegalArgumentException("Invalid value for name. Length must be greater than or equal to 1.");
            }
        ...
        return new UpdateApplicationByIdRequestBuilder(name, appId);
    }
}
