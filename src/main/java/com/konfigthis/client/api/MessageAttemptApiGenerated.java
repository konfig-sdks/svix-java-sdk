...
public class MessageAttemptApiGenerated {
    ...
    private okhttp3.Call getByDestinationCall(String appId, String msgId, String attemptId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getByDestinationValidateBeforeCall(String appId, String msgId, String attemptId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling getByDestination(Async)");
        }

        // verify the required parameter 'msgId' is set
        if (msgId == null) {
            throw new ApiException("Missing the required parameter 'msgId' when calling getByDestination(Async)");
        }

        // verify the required parameter 'attemptId' is set
        if (attemptId == null) {
            throw new ApiException("Missing the required parameter 'attemptId' when calling getByDestination(Async)");
        }

        return getByDestinationCall(appId, msgId, attemptId, _callback);

    }


    private ApiResponse<MessageAttemptOut> getByDestinationWithHttpInfo(String appId, String msgId, String attemptId) throws ApiException {
        okhttp3.Call localVarCall = getByDestinationValidateBeforeCall(appId, msgId, attemptId, null);
        Type localVarReturnType = new TypeToken<MessageAttemptOut>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getByDestinationAsync(String appId, String msgId, String attemptId, final ApiCallback<MessageAttemptOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = getByDestinationValidateBeforeCall(appId, msgId, attemptId, _callback);
        Type localVarReturnType = new TypeToken<MessageAttemptOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetByDestinationRequestBuilder {
        private final String appId;
        private final String msgId;
        private final String attemptId;

        private GetByDestinationRequestBuilder(String appId, String msgId, String attemptId) {
            this.appId = appId;
            this.msgId = msgId;
            this.attemptId = attemptId;
        }
        ...
        /**
         * Build call for getByDestination
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute getByDestination request
        ...
        public MessageAttemptOut execute() throws ApiException {
            ApiResponse<MessageAttemptOut> localVarResp = getByDestinationWithHttpInfo(appId, msgId, attemptId);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getByDestination request with HTTP info returned
        ...
        public ApiResponse<MessageAttemptOut> executeWithHttpInfo() throws ApiException {
            return getByDestinationWithHttpInfo(appId, msgId, attemptId);
        }

        /**
         * Execute getByDestination request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<MessageAttemptOut> _callback) throws ApiException {
            return getByDestinationAsync(appId, msgId, attemptId, _callback);
        }
    }
     ...
     * @param msgId The msg&#39;s ID or UID (required)
     * @param attemptId The attempt&#39;s ID (required)
     * @return GetByDestinationRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td>  </td><td>  -  </td></tr>
     ...
     */
    public GetByDestinationRequestBuilder getByDestination(String appId, String msgId, String attemptId) throws IllegalArgumentException {
        if (appId == null) throw new IllegalArgumentException("\"appId\" is required but got null");
            if (appId != null && appId.length() < 1) {
              throw new IllegalArgumentException("Invalid value for appId. Length must be greater than or equal to 1.");
            }
        ...
        return new GetByDestinationRequestBuilder(appId, msgId, attemptId);
    }
    ...
    private okhttp3.Call listByMsgAttemptedDestinationsCall(String appId, String msgId, Integer limit, String iterator, MessageStatus status, StatusCodeClass statusCodeClass, String channel, String tag, String endpointId, OffsetDateTime before, OffsetDateTime after, Boolean withContent, Set<String> eventTypes, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listByMsgAttemptedDestinationsValidateBeforeCall(String appId, String msgId, Integer limit, String iterator, MessageStatus status, StatusCodeClass statusCodeClass, String channel, String tag, String endpointId, OffsetDateTime before, OffsetDateTime after, Boolean withContent, Set<String> eventTypes, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling listByMsgAttemptedDestinations(Async)");
        }

        // verify the required parameter 'msgId' is set
        if (msgId == null) {
            throw new ApiException("Missing the required parameter 'msgId' when calling listByMsgAttemptedDestinations(Async)");
        }

        return listByMsgAttemptedDestinationsCall(appId, msgId, limit, iterator, status, statusCodeClass, channel, tag, endpointId, before, after, withContent, eventTypes, _callback);

    }


    private ApiResponse<ListResponseMessageAttemptOut> listByMsgAttemptedDestinationsWithHttpInfo(String appId, String msgId, Integer limit, String iterator, MessageStatus status, StatusCodeClass statusCodeClass, String channel, String tag, String endpointId, OffsetDateTime before, OffsetDateTime after, Boolean withContent, Set<String> eventTypes) throws ApiException {
        okhttp3.Call localVarCall = listByMsgAttemptedDestinationsValidateBeforeCall(appId, msgId, limit, iterator, status, statusCodeClass, channel, tag, endpointId, before, after, withContent, eventTypes, null);
        Type localVarReturnType = new TypeToken<ListResponseMessageAttemptOut>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listByMsgAttemptedDestinationsAsync(String appId, String msgId, Integer limit, String iterator, MessageStatus status, StatusCodeClass statusCodeClass, String channel, String tag, String endpointId, OffsetDateTime before, OffsetDateTime after, Boolean withContent, Set<String> eventTypes, final ApiCallback<ListResponseMessageAttemptOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = listByMsgAttemptedDestinationsValidateBeforeCall(appId, msgId, limit, iterator, status, statusCodeClass, channel, tag, endpointId, before, after, withContent, eventTypes, _callback);
        Type localVarReturnType = new TypeToken<ListResponseMessageAttemptOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListByMsgAttemptedDestinationsRequestBuilder {
        private final String appId;
        private final String msgId;
        private Integer limit;
        private String iterator;
        ...
        private ListByMsgAttemptedDestinationsRequestBuilder(String appId, String msgId) {
            this.appId = appId;
            this.msgId = msgId;
        }
         ...
         * Set limit
         * @param limit Limit the number of returned items (optional)
         * @return ListByMsgAttemptedDestinationsRequestBuilder
         */
        public ListByMsgAttemptedDestinationsRequestBuilder limit(Integer limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinationsRequestBuilder
         */
        public ListByMsgAttemptedDestinationsRequestBuilder iterator(String iterator) {
            this.iterator = iterator;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinationsRequestBuilder
         */
        public ListByMsgAttemptedDestinationsRequestBuilder status(MessageStatus status) {
            this.status = status;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinationsRequestBuilder
         */
        public ListByMsgAttemptedDestinationsRequestBuilder statusCodeClass(StatusCodeClass statusCodeClass) {
            this.statusCodeClass = statusCodeClass;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinationsRequestBuilder
         */
        public ListByMsgAttemptedDestinationsRequestBuilder channel(String channel) {
            this.channel = channel;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinationsRequestBuilder
         */
        public ListByMsgAttemptedDestinationsRequestBuilder tag(String tag) {
            this.tag = tag;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinationsRequestBuilder
         */
        public ListByMsgAttemptedDestinationsRequestBuilder endpointId(String endpointId) {
            this.endpointId = endpointId;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinationsRequestBuilder
         */
        public ListByMsgAttemptedDestinationsRequestBuilder before(OffsetDateTime before) {
            this.before = before;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinationsRequestBuilder
         */
        public ListByMsgAttemptedDestinationsRequestBuilder after(OffsetDateTime after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinationsRequestBuilder
         */
        public ListByMsgAttemptedDestinationsRequestBuilder withContent(Boolean withContent) {
            this.withContent = withContent;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinationsRequestBuilder
         */
        public ListByMsgAttemptedDestinationsRequestBuilder eventTypes(Set<String> eventTypes) {
            this.eventTypes = eventTypes;
            return this;
        }
        
        /**
         * Build call for listByMsgAttemptedDestinations
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute listByMsgAttemptedDestinations request
         * @return ListResponseMessageAttemptOut
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ListResponseMessageAttemptOut execute() throws ApiException {
            ApiResponse<ListResponseMessageAttemptOut> localVarResp = listByMsgAttemptedDestinationsWithHttpInfo(appId, msgId, limit, iterator, status, statusCodeClass, channel, tag, endpointId, before, after, withContent, eventTypes);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listByMsgAttemptedDestinations request with HTTP info returned
         * @return ApiResponse&lt;ListResponseMessageAttemptOut&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ListResponseMessageAttemptOut> executeWithHttpInfo() throws ApiException {
            return listByMsgAttemptedDestinationsWithHttpInfo(appId, msgId, limit, iterator, status, statusCodeClass, channel, tag, endpointId, before, after, withContent, eventTypes);
        }

        /**
         * Execute listByMsgAttemptedDestinations request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ListResponseMessageAttemptOut> _callback) throws ApiException {
            return listByMsgAttemptedDestinationsAsync(appId, msgId, limit, iterator, status, statusCodeClass, channel, tag, endpointId, before, after, withContent, eventTypes, _callback);
        }
    }
     ...
     */
    public ListByMsgAttemptedDestinationsRequestBuilder listByMsgAttemptedDestinations(String appId, String msgId) throws IllegalArgumentException {
        if (appId == null) throw new IllegalArgumentException("\"appId\" is required but got null");
            if (appId != null && appId.length() < 1) {
              throw new IllegalArgumentException("Invalid value for appId. Length must be greater than or equal to 1.");
            }
        ...
        return new ListByMsgAttemptedDestinationsRequestBuilder(appId, msgId);
    }
    private okhttp3.Call listByMsgAttemptedDestinations_0Call(String appId, String msgId, Integer limit, String iterator, String endpointId, String channel, String tag, MessageStatus status, OffsetDateTime before, OffsetDateTime after, StatusCodeClass statusCodeClass, Set<String> eventTypes, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listByMsgAttemptedDestinations_0ValidateBeforeCall(String appId, String msgId, Integer limit, String iterator, String endpointId, String channel, String tag, MessageStatus status, OffsetDateTime before, OffsetDateTime after, StatusCodeClass statusCodeClass, Set<String> eventTypes, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling listByMsgAttemptedDestinations_0(Async)");
        }

        // verify the required parameter 'msgId' is set
        if (msgId == null) {
            throw new ApiException("Missing the required parameter 'msgId' when calling listByMsgAttemptedDestinations_0(Async)");
        }

        return listByMsgAttemptedDestinations_0Call(appId, msgId, limit, iterator, endpointId, channel, tag, status, before, after, statusCodeClass, eventTypes, _callback);

    }


    private ApiResponse<ListResponseMessageAttemptOut> listByMsgAttemptedDestinations_0WithHttpInfo(String appId, String msgId, Integer limit, String iterator, String endpointId, String channel, String tag, MessageStatus status, OffsetDateTime before, OffsetDateTime after, StatusCodeClass statusCodeClass, Set<String> eventTypes) throws ApiException {
        okhttp3.Call localVarCall = listByMsgAttemptedDestinations_0ValidateBeforeCall(appId, msgId, limit, iterator, endpointId, channel, tag, status, before, after, statusCodeClass, eventTypes, null);
        Type localVarReturnType = new TypeToken<ListResponseMessageAttemptOut>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listByMsgAttemptedDestinations_0Async(String appId, String msgId, Integer limit, String iterator, String endpointId, String channel, String tag, MessageStatus status, OffsetDateTime before, OffsetDateTime after, StatusCodeClass statusCodeClass, Set<String> eventTypes, final ApiCallback<ListResponseMessageAttemptOut> _callback) throws ApiException {

        okhttp3.Call localVarCall = listByMsgAttemptedDestinations_0ValidateBeforeCall(appId, msgId, limit, iterator, endpointId, channel, tag, status, before, after, statusCodeClass, eventTypes, _callback);
        Type localVarReturnType = new TypeToken<ListResponseMessageAttemptOut>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListByMsgAttemptedDestinations0RequestBuilder {
        private final String appId;
        private final String msgId;
        private Integer limit;
        private String iterator;
        ...
        private ListByMsgAttemptedDestinations0RequestBuilder(String appId, String msgId) {
            this.appId = appId;
            this.msgId = msgId;
        }
         ...
         * Set limit
         * @param limit Limit the number of returned items (optional)
         * @return ListByMsgAttemptedDestinations0RequestBuilder
         */
        public ListByMsgAttemptedDestinations0RequestBuilder limit(Integer limit) {
            this.limit = limit;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinations0RequestBuilder
         */
        public ListByMsgAttemptedDestinations0RequestBuilder iterator(String iterator) {
            this.iterator = iterator;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinations0RequestBuilder
         */
        public ListByMsgAttemptedDestinations0RequestBuilder endpointId(String endpointId) {
            this.endpointId = endpointId;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinations0RequestBuilder
         */
        public ListByMsgAttemptedDestinations0RequestBuilder channel(String channel) {
            this.channel = channel;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinations0RequestBuilder
         */
        public ListByMsgAttemptedDestinations0RequestBuilder tag(String tag) {
            this.tag = tag;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinations0RequestBuilder
         */
        public ListByMsgAttemptedDestinations0RequestBuilder status(MessageStatus status) {
            this.status = status;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinations0RequestBuilder
         */
        public ListByMsgAttemptedDestinations0RequestBuilder before(OffsetDateTime before) {
            this.before = before;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinations0RequestBuilder
         */
        public ListByMsgAttemptedDestinations0RequestBuilder after(OffsetDateTime after) {
            this.after = after;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinations0RequestBuilder
         */
        public ListByMsgAttemptedDestinations0RequestBuilder statusCodeClass(StatusCodeClass statusCodeClass) {
            this.statusCodeClass = statusCodeClass;
            return this;
        }
         ...
         * @return ListByMsgAttemptedDestinations0RequestBuilder
         */
        public ListByMsgAttemptedDestinations0RequestBuilder eventTypes(Set<String> eventTypes) {
            this.eventTypes = eventTypes;
            return this;
        }
        
        /**
         * Build call for listByMsgAttemptedDestinations_0
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute listByMsgAttemptedDestinations_0 request
         * @return ListResponseMessageAttemptOut
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        @Deprecated
        public ListResponseMessageAttemptOut execute() throws ApiException {
            ApiResponse<ListResponseMessageAttemptOut> localVarResp = listByMsgAttemptedDestinations_0WithHttpInfo(appId, msgId, limit, iterator, endpointId, channel, tag, status, before, after, statusCodeClass, eventTypes);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listByMsgAttemptedDestinations_0 request with HTTP info returned
         * @return ApiResponse&lt;ListResponseMessageAttemptOut&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        @Deprecated
        public ApiResponse<ListResponseMessageAttemptOut> executeWithHttpInfo() throws ApiException {
            return listByMsgAttemptedDestinations_0WithHttpInfo(appId, msgId, limit, iterator, endpointId, channel, tag, status, before, after, statusCodeClass, eventTypes);
        }

        /**
         * Execute listByMsgAttemptedDestinations_0 request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        @Deprecated
        public okhttp3.Call executeAsync(final ApiCallback<ListResponseMessageAttemptOut> _callback) throws ApiException {
            return listByMsgAttemptedDestinations_0Async(appId, msgId, limit, iterator, endpointId, channel, tag, status, before, after, statusCodeClass, eventTypes, _callback);
        }
    }
     ...
     */
    @Deprecated
    public ListByMsgAttemptedDestinations0RequestBuilder listByMsgAttemptedDestinations_0(String appId, String msgId) throws IllegalArgumentException {
        if (appId == null) throw new IllegalArgumentException("\"appId\" is required but got null");
            if (appId != null && appId.length() < 1) {
              throw new IllegalArgumentException("Invalid value for appId. Length must be greater than or equal to 1.");
            }
        ...
        return new ListByMsgAttemptedDestinations0RequestBuilder(appId, msgId);
    }
    private okhttp3.Call resendMessageToEndpointCall(String appId, String msgId, String endpointId, String idempotencyKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call resendMessageToEndpointValidateBeforeCall(String appId, String msgId, String endpointId, String idempotencyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'appId' is set
        if (appId == null) {
            throw new ApiException("Missing the required parameter 'appId' when calling resendMessageToEndpoint(Async)");
        }

        // verify the required parameter 'msgId' is set
        if (msgId == null) {
            throw new ApiException("Missing the required parameter 'msgId' when calling resendMessageToEndpoint(Async)");
        }

        // verify the required parameter 'endpointId' is set
        if (endpointId == null) {
            throw new ApiException("Missing the required parameter 'endpointId' when calling resendMessageToEndpoint(Async)");
        }

        return resendMessageToEndpointCall(appId, msgId, endpointId, idempotencyKey, _callback);

    }


    private ApiResponse<Void> resendMessageToEndpointWithHttpInfo(String appId, String msgId, String endpointId, String idempotencyKey) throws ApiException {
        okhttp3.Call localVarCall = resendMessageToEndpointValidateBeforeCall(appId, msgId, endpointId, idempotencyKey, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call resendMessageToEndpointAsync(String appId, String msgId, String endpointId, String idempotencyKey, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = resendMessageToEndpointValidateBeforeCall(appId, msgId, endpointId, idempotencyKey, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }

    public class ResendMessageToEndpointRequestBuilder {
        private final String appId;
        private final String msgId;
        private final String endpointId;
        private String idempotencyKey;

        private ResendMessageToEndpointRequestBuilder(String appId, String msgId, String endpointId) {
            this.appId = appId;
            this.msgId = msgId;
            this.endpointId = endpointId;
        }
         ...
         * @return ResendMessageToEndpointRequestBuilder
         */
        public ResendMessageToEndpointRequestBuilder idempotencyKey(String idempotencyKey) {
            this.idempotencyKey = idempotencyKey;
            return this;
        }
        
        /**
         * Build call for resendMessageToEndpoint
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute resendMessageToEndpoint request
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public void execute() throws ApiException {
            resendMessageToEndpointWithHttpInfo(appId, msgId, endpointId, idempotencyKey);
        }

        /**
         * Execute resendMessageToEndpoint request with HTTP info returned
         * @return ApiResponse&lt;Void&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return resendMessageToEndpointWithHttpInfo(appId, msgId, endpointId, idempotencyKey);
        }

        /**
         * Execute resendMessageToEndpoint request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return resendMessageToEndpointAsync(appId, msgId, endpointId, idempotencyKey, _callback);
        }
    }
     ...
     */
    public ResendMessageToEndpointRequestBuilder resendMessageToEndpoint(String appId, String msgId, String endpointId) throws IllegalArgumentException {
        if (appId == null) throw new IllegalArgumentException("\"appId\" is required but got null");
            if (appId != null && appId.length() < 1) {
              throw new IllegalArgumentException("Invalid value for appId. Length must be greater than or equal to 1.");
            }
        ...
        return new ResendMessageToEndpointRequestBuilder(appId, msgId, endpointId);
    }
}
