...
public class BackgroundTasksApiTest {
    ...
    private static BackgroundTasksApi api;
    ...
    public void getTaskByIdTest() throws ApiException {
        String taskId = null;
        BackgroundTaskOut response = api.getTaskById(taskId)
                .execute();
     ...
     */
    @Test
    public void listRecentTasksTest() throws ApiException {
        BackgroundTaskStatus status = null;
        BackgroundTaskType task = null;
        Integer limit = null;
        String iterator = null;
        Ordering order = null;
        ListResponseBackgroundTaskOut response = api.listRecentTasks()
                .status(status)
                .task(task)
                .limit(limit)
                .iterator(iterator)
