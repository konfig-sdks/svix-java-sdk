...
public class StatisticsApiTest {
     ...
     */
    @Test
    public void calculateEventTypesForAllAppsTest() throws ApiException {
        AggregateEventTypesOut response = api.calculateEventTypesForAllApps()
                .execute();
     ...
     */
    @Test
    public void calculateMessageDestinationsTest() throws ApiException {
        OffsetDateTime since = null;
        OffsetDateTime until = null;
        Set<String> appIds = null;
        String idempotencyKey = null;
        AppUsageStatsOut response = api.calculateMessageDestinations(since, until)
                .appIds(appIds)
