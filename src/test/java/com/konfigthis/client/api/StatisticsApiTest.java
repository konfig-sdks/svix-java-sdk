...
public class StatisticsApiTest {
     ...
     */
    @Test
    public void calculateEventTypesForAppsTest() throws ApiException {
        AggregateEventTypesOut response = api.calculateEventTypesForApps()
                .execute();
     ...
     */
    @Test
    public void calculateMessageDestinationsForAppsTest() throws ApiException {
        OffsetDateTime since = null;
        OffsetDateTime until = null;
        Set<String> appIds = null;
        String idempotencyKey = null;
        AppUsageStatsOut response = api.calculateMessageDestinationsForApps(since, until)
                .appIds(appIds)
