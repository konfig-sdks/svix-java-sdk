...
public class IntegrationApiTest {
    ...
    private static IntegrationApi api;
     ...
     */
    @Test
    public void createNewIntegrationTest() throws ApiException {
        String name = null;
        String appId = null;
        String idempotencyKey = null;
        IntegrationOut response = api.createNewIntegration(name, appId)
    ...
    public void getByIdTest() throws ApiException {
        String appId = null;
        String integId = null;
        IntegrationOut response = api.getById(appId, integId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getKeyTest() throws ApiException {
        String appId = null;
        String integId = null;
        IntegrationKeyOut response = api.getKey(appId, integId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listIntegrationsTest() throws ApiException {
        ...
        ListResponseIntegrationOut response = api.listIntegrations(appId)
                .limit(limit)
                .iterator(iterator)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void rotateIntegrationKeyTest() throws ApiException {
        String appId = null;
        String integId = null;
        String idempotencyKey = null;
        IntegrationKeyOut response = api.rotateIntegrationKey(appId, integId)
                .idempotencyKey(idempotencyKey)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateIntegrationTest() throws ApiException {
        ...
        String appId = null;
        String integId = null;
        IntegrationOut response = api.updateIntegration(name, appId, integId)
                .execute();
        // TODO: test validations
    }
