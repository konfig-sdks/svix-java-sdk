...
public class ApplicationApiTest {
    ...
    public void createNewApplicationTest() throws ApiException {
        ...
        ApplicationOut response = api.createNewApplication(name)
                .rateLimit(rateLimit)
                .uid(uid)
                .metadata(metadata)
    ...
    public void getByIdTest() throws ApiException {
        String appId = null;
        ApplicationOut response = api.getById(appId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listAllTest() throws ApiException {
        ...
        Ordering order = null;
        ListResponseApplicationOut response = api.listAll()
                .limit(limit)
                .iterator(iterator)
                .order(order)
                .execute();
    ...
    public void partiallyUpdateTest() throws ApiException {
        ...
        String uid = null;
        Map<String, String> metadata = null;
        ApplicationOut response = api.partiallyUpdate(appId)
                .name(name)
                .rateLimit(rateLimit)
                .uid(uid)
                .metadata(metadata)
     ...
     */
    @Test
    public void updateApplicationByIdTest() throws ApiException {
        String name = null;
        String appId = null;
        Integer rateLimit = null;
        String uid = null;
        Map<String, String> metadata = null;
        ApplicationOut response = api.updateApplicationById(name, appId)
                .rateLimit(rateLimit)
                .uid(uid)
                .metadata(metadata)
                .execute();
