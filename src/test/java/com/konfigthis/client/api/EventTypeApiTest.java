...
public class EventTypeApiTest {
    ...
    public void getEventTypeTest() throws ApiException {
        String eventTypeName = null;
        EventTypeOut response = api.getEventType(eventTypeName)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        ListResponseEventTypeOut response = api.list()
                .limit(limit)
                .iterator(iterator)
                .order(order)
     ...
     */
    @Test
    public void partiallyUpdateEventTypeTest() throws ApiException {
        String eventTypeName = null;
        String description = null;
        Boolean archived = null;
        Map<String, Object> schemas = null;
        String featureFlag = null;
        EventTypeOut response = api.partiallyUpdateEventType(eventTypeName)
     ...
     */
    @Test
    public void updateEventTypeNameTest() throws ApiException {
        String description = null;
        String eventTypeName = null;
        Boolean archived = null;
        Map<String, Object> schemas = null;
        String featureFlag = null;
        EventTypeOut response = api.updateEventTypeName(description, eventTypeName)
                .archived(archived)
                .schemas(schemas)
                .featureFlag(featureFlag)
                .execute();
